...
Download [CS370\_Assign04.zip](src/CS370_Assign04.zip), saving it into the **CS370-Fall2022** directory.

Double-click on **CS370\_Assign04.zip** and extract the contents of the archive into a subdirectory called **CS370\_Assign04**

Open CLion, select **CS370-Fall2022** from the main screen (you may need to close any open projects), and open the **CMakeLists.txt** file in this directory (**not** the one in the **CS370\_Assign04** subdirectory). Uncomment the line
